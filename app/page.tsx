      ...
      <section className="w-full relative z-2 w-full flex justify-center">
        <div className="relative flex flex-col px-16 max-w-screen-lg py-16 grid grid-cols-2 gap-16">
          ...
          <div className="grid grid-rows-2 gap-8 ">
            <div className="bg-blue-400  border-x-0 border-b-[0.2rem] hover:border hover:border-b-4 border-t-0 rounded-lg h-60 w-80 grid grid-rows-5">
              <div className='bg-[url("/assets/product/yt_pemrograman.png")] bg-cover rounded-t-lg row-span-2'>

              </div>
              <div className="bg-white rounded-b-md row-span-3 text-utama flex flex-col items-center justify-center px-8">
                <h1 className="text-xl font-bold">Pemrograman Tech</h1>
                <p className="text-center">I create website or blog, instagram and Youtube for Tutorial about Tech such as web Programming.</p>
              </div>
            </div>
            <div className="grid grid-cols-5 gap-4 auto-rows-max">
              <div className="bg-blue-400 border-x-0 border-b-[0.2rem] hover:border hover:border-b-4 hover:border-blue-800 cursor-pointer border-t-0 rounded-lg h-12 flex justify-center">
