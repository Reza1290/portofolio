...
const CardJourneyComponent: React.FC<CardJourneyComponentProps> = ({ children }) => {
    ...
    return (
        <div className="relative group ">
            ...
            <div onClick={set} className={`${readMore ? 'rotate-180 border-b-0 border-t-[0.2rem]' : 'border-t-0 border-b-[0.2rem]'} cursor-pointer absolute -bottom-2 bg-red-500 border border-x-0   border-red-700 max-w-10 self-end w-8 rounded-lg fill-white h-8 p-2 group-hover:bg-red-600 flex items-end transition-all ease-in`}>
