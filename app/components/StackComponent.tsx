...
const StackComponent: React.FC<StackComponentProps> = ({ id, name, imageUrl, first, last, type }) => {
    return (
        ...
        >
            ...
            <div className="text-white font-bold peer-checked:block hidden bg-blue-400 hover:bg-blue-500 h-10 max-sm:h-5 w-40 max-sm:w-20  absolute rounded-md rotate-[-5deg] -top-[5.2rem] transition-opacity ease-in-out delay-150 duration-300">
